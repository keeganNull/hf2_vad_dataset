...
def obj_bboxes_extraction(dataset_root, dataset_name, mode):
    ...
    mm_det_config_file = '/data1/hzj_1/model/latest_version_cascade_rcnn_r101_fpn_1x.py'
    mm_det_ckpt_file = '/data1/hzj_1/model/cascade_rcnn_r101_fpn_1x_coco_20200317-0b6a2fbf.pth'

    dataset = get_dataset(dataset_name=dataset_name,
                          dir=os.path.join(dataset_root, dataset_name),
                          context_frame_num=1, mode=mode)

    mm_det_model = init_detector(mm_det_config_file, mm_det_ckpt_file, device="cuda:3")
...
if __name__ == '__main__':
    ...
    obj_bboxes_extraction(dataset_root=args.proj_root,
